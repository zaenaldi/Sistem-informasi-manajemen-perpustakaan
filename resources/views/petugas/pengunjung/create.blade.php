...
<div class="bg-white rounded-lg shadow-md p-6">
    <h2 class="text-xl font-semibold mb-6 text-center">Tambah Pengunjung Baru</h2>
    
    <form action="{{ route('petugas.pengunjung.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nis" id="nis" 
                       ...
                       value="{{ old('nis') }}" required maxlength="20">
                @error('nis')
