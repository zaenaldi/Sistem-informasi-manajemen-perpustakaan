...
@section('content')
<div class="min-h-screen flex justify-center items-center px-4 py-6 bg-gray-50">
    <div class="bg-white rounded-lg shadow border border-gray-100 p-8 w-full max-w-7xl">
